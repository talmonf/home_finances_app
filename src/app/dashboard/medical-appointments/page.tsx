...
import { createMedicalAppointment, toggleMedicalAppointmentActive } from "./actions";
        ...
        <section className="space-y-4">
          ...
          >
            ...
            <div>
              ...
              <input id="notes" name="notes" className={inputClass} placeholder="Anything else to remember" />
            </div>
                ...
                <tbody>
                  {appointments.map((row) => (
                    <tr key={row.id} className="border-b border-slate-700/80 align-top hover:bg-slate-800/40">
                      ...
                      <td className="px-4 py-3">
                        <form
                          action={toggleMedicalAppointmentActive.bind(null, row.id, !row.is_active)}
                          className="inline"
                        >
