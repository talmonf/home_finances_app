...
export function AddRentalForm({ propertyId, bankAccounts, creditCards }: AddRentalFormProps) {
  return (
    <section className="space-y-4">
      <h2 className="text-lg font-medium text-slate-200">Add rental</h2>
      <form
        action={createRental}
        className="grid gap-3 rounded-xl border border-slate-700 bg-slate-900/60 p-4 sm:grid-cols-2 lg:grid-cols-4"
      >
