...
export function RentalsTableClient({ propertyId, rows, selectedRentalId }: RentalsTableClientProps) {
    ...
    return (
      <section className="space-y-4">
        ...
        <p className="rounded-xl border border-slate-700 bg-slate-900/60 p-6 text-center text-sm text-slate-400">
          No rentals yet. Use the form below to add one, then manage tenants, contracts, and transaction links in the
          details panel.
        </p>
      </section>
    );
