  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-3 md:grid-cols-3">
      ...
      <div className="space-y-1 md:col-span-1">
        ...
        <p className="text-[11px] leading-snug text-slate-500">When you paid or renewed (optional).</p>
      ...
      <div className="space-y-1 md:col-span-1">
        ...
        <p className="text-[11px] leading-snug text-slate-500">End of the license validity period (required).</p>
      ...
      <input name="notes" placeholder="License notes" className={`md:col-span-2 ${field}`} />
