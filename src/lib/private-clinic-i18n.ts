...
export function privateClinicClients(lang: UiLanguage) {
  ...
  return {
    ...
    colRecorded: p("Record date", "תאריך רישום"),
...
export function privateClinicTreatments(lang: UiLanguage) {
  ...
  return {
    ...
    importAutoProgramHint: p(
      "No programs for this job; a default one will be created automatically.",
      "אין תוכניות למשרה זו; תוכנית ברירת מחדל תיווצר אוטומטית.",
    ),
