...
export function privateClinicClients(lang: UiLanguage) {
  ...
  return {
    ...
    holdPeriodsHelp: p(
      "Dated hospital stays or other holds. Days on hold are excluded from active-client counts. Resume date is the day they returned to service.",
      "אשפוזים או השהיות אחרות עם תאריכים. ימי השהיה לא נספרים כלקוח פעיל. תאריך החזרה הוא היום שבו חזרו לשירות.",
    ),
    ...
    holdColActions: p("Actions", "פעולות"),
    ...
    holdResume: p("Resume", "חזרה לשירות"),
    holdSave: p("Save period", "שמירת תקופה"),
    holdDelete: p("Delete", "מחיקה"),
    ...
    errHoldNoOpen: p("There is no open hold period to resume.", "אין תקופת השהיה פתוחה לחזרה לשירות."),
