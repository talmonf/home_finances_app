...
| 080 | `080_users_show_useful_links.sql` | ALTER | `users`: `show_useful_links` (boolean, default true) — super-admin toggle for dashboard useful-links UI per user. |
...
- [x] 080_users_show_useful_links.sql
